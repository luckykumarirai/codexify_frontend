    ...
    <>
      {data ? (
        <>
          {data?.map((item) => (
            <>
              <div className="w-full lg:w-auto rounded-lg shadow-sm border p-4 bg-white flex mb-4">
                <div className="lg:pl-4 pl-0 basis-3/4">
                ...
                <div className="basis-1/4 space-x-2 flex items-center justify-center">
